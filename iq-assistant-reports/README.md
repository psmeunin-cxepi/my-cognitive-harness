...
1. Traces are ingested into the Neo4j KG via the [`iq-trace-ingest`](../.agents/skills/iq-trace-ingest/SKILL.md) skill. Feedback and triage data are loaded from `triage/annotation_feedback/` docs.
